...
if no_model:
    ...
    *_image, *_label, and *_data all work like this 
    ...
    model.save('saved_model/demo_1_testing_vis_only')

    print("\n\n---> Saved the model.\n\n")

else:
    model = tf.keras.models.load_model('saved_model/demo_1_testing_vis_only')
