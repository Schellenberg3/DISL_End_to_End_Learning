...
def get_model():
    ...
    z = Dense(128, activation="relu")(model_x.output)
    z = Reshape((1, 128))(z)
    ...
    _model = Model(inputs=model_x.input, outputs=z)
...
# todo: make a separate file for generating demos
if live_demos:
    num_live_demos = 20
...
if no_model:
    ...
    *_image, *_label, and *_data all work like this 
    ...
    model.save('saved_model/demo_1_testing_pos_only')

    print("\n\n---> Saved the model.\n\n")

else:
    model = tf.keras.models.load_model('saved_model/demo_1_testing_pos_only')
